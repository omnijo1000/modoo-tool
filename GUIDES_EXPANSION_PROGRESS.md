...
**2026-08-26 추가 — 영어 번역 진행**: ko 250개 완료 후 영어 번역 착수. 진행 상황·전체 176개 체크리스트·작업 절차는 별도 파일 **`EN_TRANSLATION_PROGRESS.md`**(repo 루트)에서 관리. 이 파일(GUIDES_EXPANSION_PROGRESS.md)은 ko 원본 작성 기록 전용, EN 관련 세부 내용은 더 이상 여기 추가하지 않음.
...
**영어 번역 진행 상황은 `EN_TRANSLATION_PROGRESS.md` 참고.**
