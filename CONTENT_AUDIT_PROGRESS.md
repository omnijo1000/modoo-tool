...
**남은 43개 (worst-first, char count)** — 다음 배치는 여기서부터 3개씩:
```
807  keyword-cannibalization-checker.html ⬜ 다음 배치 시작점
